---
title: "CL_Symptoms_Of_Respiratory_Infection_10"
author: "Group K"
date: "`r Sys.Date()`"
output: pdf_document
---
...
## Assumed pattern, the missing values can be filled with the non missing value in the opposite attribute
```{r, echo=TRUE}
...
```
```{r}
write_csv(ari_df, here("cleaned_data", "symptoms-of-acute-respiratory-infection-ari_cleaned.csv"))
```