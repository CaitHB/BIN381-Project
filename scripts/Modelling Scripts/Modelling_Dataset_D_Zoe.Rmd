...
##csv_path <- read.csv(here( "merged datasets","GroupD_Social_merged.csv"))
...
csv_path <- here("merged datasets", "GroupD_Social_merged.csv")
...
saveRDS(rf_fit, file = "rf_model_GroupD_Social.rds")
