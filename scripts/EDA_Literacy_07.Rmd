...
glimpse(literacyDataset)

summary(literacyDataset)
```
...
kable(data_dictionary, caption = "Data Dictionary for the DHS Literacy Dataset")

# Save dictionary
write_csv(data_dictionary, "../outputs/dictionary/dhs_literacy_dictionary.csv")
