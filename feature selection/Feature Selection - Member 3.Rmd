...
dataB <- read_csv(here("merged datasets", "GroupB_Sanitation_merged.csv"))
dataC <- read_csv(here("merged datasets", "GroupC_Nutrition_merged.csv"))
dataD <- read_csv(here("merged datasets", "GroupD_Social_merged.csv"))
...
head(combined_data) %>%
  kable(caption = "First few rows of the combined dataset", booktabs = TRUE) %>%
